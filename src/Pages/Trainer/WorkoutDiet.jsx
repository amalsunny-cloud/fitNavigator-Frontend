...
const WorkoutDiet = () => {
  ...
  const fetchWorkouts = async () => {
    try {
      const response = await axios.get(
        `${import.meta.env.VITE_API_URL}/get-all-workouts`
      );
  ...
  const fetchDietPlans = async () => {
    try {
      const response = await axios.get(`${import.meta.env.VITE_API_URL}/get-dietplans`);
      setDietPlans({
  ...
  const handleSubmit = async (e) => {
    ...
    try {
      if (editingId) {
        if (formType === "workout") {
          await axios.put(
            `${import.meta.env.VITE_API_URL}/update-assign-workoutplan/${editingId}`,
            {
          ...
          await axios.put(
            `${import.meta.env.VITE_API_URL}/update-dietplan/${editingId}`,
            {
              planname: formData.name,
              instructions: formData.description,
              userId: formData.userId,
        ...
        if (formType === "workout") {
          await axios.post(`${import.meta.env.VITE_API_URL}/assign-workouts`, {
            planname: formData.name,
            instructions: formData.description,
            userId: formData.userId,
          });
          ...
          await axios.post(`${import.meta.env.VITE_API_URL}/post-dietplans`, {
            planname: formData.name,
            instructions: formData.description,
            userId: formData.userId,
          });
    ...
    try {
      if (type === "workout") {
        ...
        const response1 = await axios.delete(
          `${import.meta.env.VITE_API_URL}/delete-assignworkout/${id}`
        );
        ...
        const response2 = await axios.delete(
          `${import.meta.env.VITE_API_URL}/delete-dietplan/${id}`
        );
